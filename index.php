...
<div class="container m-t-10">
    <div class="row">
            ...
            <div class="jumbotron">
              <h4 class="text-center m-b-20">Enter Information to Get Offer</h4>
                <form name="register" method="POST" action="view.php">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="number" number="number" placeholder="Please Enter Your Number">
                    </div>
